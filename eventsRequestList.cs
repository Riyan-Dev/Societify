...
namespace Societify
{
    public partial class eventsRequestList : Form
    {
        public eventsRequestList()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable dtSocieties = GetSocietiesInEventsApprovalRequests();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                this.Hide();
                eventRequestPanel newForm = new eventRequestPanel(societyID,eventID);
